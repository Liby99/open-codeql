//! Extract Java source files into a database and dump as CSV.
//!
//! Usage:
//!   extract-java <source-dir> <output-dir>
//!
//! Detects Gradle/Maven project structure automatically and extracts
//! from the appropriate source roots.
...
fn main() {
    ...
    if args.len() < 3 {
        eprintln!("Usage: extract-java <source-dir> <output-dir>");
        std::process::exit(1);
    }
